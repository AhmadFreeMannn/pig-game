...
Every roll (except 1) adds its value to the current score.

If a player rolls 1, they lose their current score, and the turn switches.

A player can “Hold” to add the current score to their total.
...
DRY structure using an init() function
